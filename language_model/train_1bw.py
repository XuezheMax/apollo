...
if __name__ == "__main__":
    ...
    parser.add_argument('--milestone', type=int, nargs='+', default=[8], help='Decrease learning rate at these epochs.')
    parser.add_argument('--warmup_updates', type=int, default=100, metavar='N', help='number of updates to warm up (default: 100)')
